...
const masterQuizList = {
  ...
  "7": {
    ...
    dialogue: [
      ...
      { word: "点", pinyin: "diǎn", meaning: "order (food)" },
  ...
  "8": { title: "Lesson 8", subtitle: "在朋友家做客​ (Visiting a Friend’s Family)", dialogue: [], reading: [], vocab: lesson8Vocab },
  "9": { title: "Lesson 9", subtitle: "音乐 (Music)", dialogue: [], reading: [], vocab: lesson9Vocab },
  "10": { title: "Lesson 10", subtitle: "购物 (Shopping)", dialogue: [], reading: [], vocab: lesson10Vocab },
  "11": { title: "Lesson 11", subtitle: "农历新年 (Lunar New Year)", dialogue: [], reading: [], vocab: lesson11Vocab },
  "12": { title: "Lesson 12", subtitle: "中秋节 (Mid-Autumn Festival)", dialogue: [], reading: [], vocab: lesson12Vocab },
};
